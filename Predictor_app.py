...
def app_ui():
    main_layout=html.Div(
        [
            html.H1(children="Sentimental Analysis with Insights",style={'text-align':'center','font-family':'Impact','color':'#000000','font-size':'80px','margin-top':'20px','margin-bottom':'20px'}),
            dbc.NavbarSimple(
                children=[
            ...
            html.Div([
            dbc.Jumbotron([
                html.H1(children="Percentage of Positive and Negative Reviews",style={'text-align':'center','margin-bottom':'10px'}),
                dcc.Graph(id="pie", figure=figure())
            ],
                style={'background-color':'#7FB3D5','box-shadow':' 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'}
            )

            ],
                style={'width':'80%', 'margin-top':'20px','margin-bottom':'20px','text-align':'center','margin-left':'150px'},
                id="pie_div"
            ...
            html.Div([
                ...
                ,style={'background-color':'#7FB3D5','box-shadow':' 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)','text-align':'center','margin-top':'40px'}
                ),
            ...
            html.Div([
                dbc.Jumbotron([
                    html.H1(children="Choose a Review from the dropdown below",style={'text-align':'center'}),
                    dcc.Dropdown(
                        id='review_dropdown',
            ...
            , style = {'width': '80%','margin-left':'150px'}, id="dropdown_div"
            )
            ,
            html.Div([
                dbc.Jumbotron([
                    html.H1(children="Enter a review",style={'text-align':'center'}),
                    dcc.Textarea(
                        id='review_text',
                ...
                style={'width': '80%', 'margin-left': '150px','margin-bottom':'30px'}, id="text_div"
            )
